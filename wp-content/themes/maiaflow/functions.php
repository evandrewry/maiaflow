 ...
 */
function maiaflow_infinite_scroll_init() {
...
add_action( 'after_setup_theme', 'maiaflow_infinite_scroll_init' );

/**
 * Enqueue CSS stylesheet with theme styles for Infinite Scroll.
 */
function maiaflow_infinite_scroll_enqueue_styles() {
	wp_enqueue_style( 'infinity-twentythirteen', plugins_url( 'infinite-scroll.css', __FILE__ ), array( 'the-neverending-homepage' ), '20130409' );
}
add_action( 'wp_enqueue_scripts', 'maiaflow_infinite_scroll_enqueue_styles', 25 );
